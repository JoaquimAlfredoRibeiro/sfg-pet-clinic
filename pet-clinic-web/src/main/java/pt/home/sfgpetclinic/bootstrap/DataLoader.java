...
import pt.home.sfgpetclinic.services.PetTypeService;
import pt.home.sfgpetclinic.services.SpecialtyService;
import pt.home.sfgpetclinic.services.VetService;
...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        radiology.setDescprition("Radiology");
        Specialty savedRadiology = specialtyService.save(radiology);

        Specialty surgery = new Specialty();
        surgery.setDescprition("Surgery");
        Specialty savedSurgery = specialtyService.save(surgery);

        Specialty dentistry = new Specialty();
        dentistry.setDescprition("Dentistry");
        ...
        owner2.setAdress("Rua da Escola 13");
